...
<body class="hold-transition skin-purple sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<section class="content">
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共${pageInfo.pageSize} 页，共${pageInfo.total} 条数据。 每页
                            <select class="form-control" id="changePageSize" onchange="changePageSize('${pageContext.request.contextPath}/orders/findAll')">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
	...
	<script
		src="${pageContext.request.contextPath}/js/pageInfoCommon.js"></script>
	<script>
