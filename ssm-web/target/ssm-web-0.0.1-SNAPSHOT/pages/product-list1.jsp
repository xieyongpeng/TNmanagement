                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"><i
                                            class="fa fa-file-o" onclick="${pageContext.request.contextPath}/pages/product-add.jsp'"></i> 新建
                                    </button>
                                    <button type="button" class="btn btn-default" title="删除"><i
                                            class="fa fa-trash-o"></i> 删除
                                    </button>
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize('${pageContext.request.contextPath}/product/findAll')">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
