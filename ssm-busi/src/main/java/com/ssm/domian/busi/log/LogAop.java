package com.ssm.domian.busi.log;
...
public class LogAop {
	...
	@Before("execution(* com.ssm.domian.web.controller.*.*(..))")
	public void doBeforeLog(JoinPoint jp) throws Exception, SecurityException{
	...
	//后置通知
    @After("execution(* com.ssm.domian.web.controller.*.*(..))")
